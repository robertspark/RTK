Work in progress for an RTK Base and Rover Station using a Raspberry Pi, along with a UM980 RTK GNSS Reciever, and a Accelerometer, Gyroscope and Magnetometer chip.
